...
```sh
git clone https://github.com/ljgago/typst-chords ~/.local/share/typst/packages/local/chordx/0.6.1
```

And import the package in your file:

```typ
#import "@local/chordx:0.6.1": *
```
...
```typ
#import "@preview/chordx:0.6.1": piano-chord
...
```typ
#import "@preview/chordx:0.6.1": single-chord
